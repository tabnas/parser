...
This mirrors the canonical TypeScript package, where every grammar (even strict JSON) arrives as a plugin rather than being baked in. A
...
plugin, not in your input, and the hint text says as much.
...
or ender, and not only where ASCII reaches.
