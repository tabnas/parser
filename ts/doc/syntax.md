...
amagama accepts standard JSON and extends it with the relaxations described
below. All extensions are optional -- valid JSON always parses correctly.

## Objects

Standard JSON objects work as expected. amagama also supports:
...
Standard JSON arrays work as expected. amagama also supports:
