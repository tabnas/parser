...
// let json = Amagama.make('json')

// console.log(util.deep(undefined, 1))
// console.log(util.deep(1, /a/))

// console.log(Amagama('{x:[a:1,2]}',{log:-1}))

// console.log(Amagama('[a:b:c, a:d:e]'))
...
// console.log(Amagama('[{a:1 b:2}]', { log: -1 }))

// console.log(Amagama.make().token('#CA'))
