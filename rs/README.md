...
Not yet equivalent to the mature TypeScript/Go engines: serialized grammar
loading, arbitrary matcher callbacks, plugin option overlays, rewind/recovery,
continuations, subscribers, parse budgets, and the full builtin library. See
